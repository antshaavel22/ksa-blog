...
${max < MAX_CHARS
    ? "- Keep the ONE or TWO most important specifics and drop the rest. Cutting is the\n"
      + "  point here — a list of every finding cannot fit, so choose the strongest and\n"
      + "  let the others go rather than compressing all of them into clauses."
