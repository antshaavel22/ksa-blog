---
title: "Noored silmad, vanainimese probleemid: kuidas liigne ekraaniaeg silmi mõjutab?"
...
categories:
  ...
  - Silmad Ja Tervis
tags: []
excerpt: "Pikk ekraaniaeg vähendab pilgutamist ja võib soodustada silmade kuivust juba lastel ja noortel. Kuidas kaitsta silmi ekraani kasutades ja millised lihtsad harjumused aitavad silmade kuivust ennetada?"
...
llmSearchQueries:
  - "kuidas ekraaniaeg mõjutab laste silmi"
  - "miks lapse silmad kipitavad pärast telefoni kasutamist"
  - "kuiv silm lastel sümptomid"
  - "kas ekraaniaeg põhjustab kuiva silma"
  - "miks pilgutamine ekraani vaadates väheneb"
  - "Meibomi näärmed ja kuiv silm"
  - "kas lapsel võib olla kuiv silm"
  - "nutiseadmete mõju silmade tervisele lastel"
  - "miks silmad vesivad ekraani vaadates"
  - "kuidas vähendada ekraaniaja mõju silmadele"
faqItems:
  - q: "Kas liigne ekraaniaeg võib põhjustada lastel kuiva silma?"
    a: "Pikem ekraaniaeg võib olla üks kuiva silma vaevusi soodustavaid tegureid, sest see mõjutab pilgutamissagedust ja silma pinda kaitsvat pisarakilet. Kuiva silma vaevused ei puuduta ainult täiskasvanuid, vaid esinevad ka lastel ja teismelistel."
  - q: "Miks pilgutamine ekraani vaadates harveneb?"
    a: "Kui aju keskendub ekraanil toimuvale, aeglustub loomulik pilgutamisrütm ning osa pilgutustest jääb poolikuks. Ühes 6–15-aastaste lastega tehtud uuringus langes pilgutamissagedus nutitelefonis mängimise ajal keskmiselt 20,8 pilgutuselt 8,9 pilgutuseni minutis."
  - q: "Mis rolli mängivad Meibomi näärmed silmade niiskuses?"
    a: "Meibomi näärmed toodavad rasvarikast sekreeti ehk meibumit, mis moodustab pisarakile välimise kihi ja takistab pisarate liiga kiiret aurustumist. Täieliku pilgutuse ajal jõuab see sekreet lauservale ja sealt silma pinnale, mistõttu on oluline mitte ainult pilgutamise sagedus, vaid ka selle täielikkus."
  - q: "Millised sümptomid võivad viidata kuivale silmale lapsel?"
    a: "Kuiva silma puhul võivad esineda silmade kipitus või põletustunne, tunne nagu oleks silmas liivatera, punetus, sage hõõrumine, nägemise perioodiline hägustumine, valguskartlikkus, kiire väsimine ja vesitsemine. Lastel võib probleem väljenduda ka sagedases silmade hõõrumises, pilgutamises või soovis ekraanist eemale vaadata."
  - q: "Kas vesised silmad tähendavad, et silm on piisavalt niisutatud?"
    a: "Ei pruugi. Kuiv ja ärritunud silmapind võib käivitada reflektoorse pisaravoolu, mistõttu vesised silmad ei tähenda alati, et pisaraid oleks piisavalt või silma pind oleks hästi niisutatud."
  - q: "Kas ühe tunni ekraaniaeg kahjustab lapse silmi püsivalt?"
    a: "Tund aega telefonis ei põhjusta lapsele püsivat silmakahjustust, kuid juba selle aja jooksul võivad kuiva silma sümptomid suureneda. See näitab, kui kiiresti ekraanile keskendumine muudab silmade loomulikku tööd."
---
...
Tegelikult võib pikaajaline ekraanikasutus mõjutada ka silmapinda kaitsvat pisarakilet.
...
Võib öelda, et see rasukiht toimib pisarakile kaitsekihina. Kui seda on liiga vähe või selle koostis muutub, ei püsi pisarakile silmapinnal enam sama stabiilsena ning silm võib hakata kiiremini kuivama.

Pilgutamisel on siin väga oluline roll. Täieliku pilgutuse ajal sulguvad silmalaud ning Meibomi näärmete sekreet jõuab lauservale ja sealt edasi silmapinnale.
...
Lisaks võivad pilgutused muutuda poolikuks. Silmalaud liiguvad küll üksteise poole, kuid ei sulgu täielikult. Selle tulemusena saab silmapind harvem värske pisarakihi ning Meibomi näärmete sekreet ei pruugi jaotuda silmapinnale sama tõhusalt.
...
Viimane võib tunduda vastuoluline, kuid kuiv ja ärritunud silmapind võib käivitada reflektoorse pisaravoolu. Seega ei tähenda vesised silmad alati seda, et pisaraid oleks piisavalt või et silmapind oleks hästi niisutatud.
...
Pausi ajal tasub teha ka mõned rahulikud ja teadlikult täielikud pilgutused. Sulge silmad korralikult, hoia neid hetkeks kinni ja ava uuesti.

Selline väike harjumus aitab taastada loomulikku pilgutamisrütmi ja jaotada pisarakile paremini üle silmapinna.
...
Kuiva silma diagnoos ei põhine ainult sellel, mida laps tunneb. Oluline on hinnata ka pisarakile stabiilsust, silmapinda ja vajadusel Meibomi näärmete seisundit.

KSA Silmakeskuses saame selleks kasutada kontaktivaba diagnostikat.

**NIBUT-testiga** mõõdame, kui kaua püsib pisarakile pärast pilgutamist silmapinnal stabiilsena. Tulemust hinnatakse koos teiste näitajatega, sest kuiva silma diagnoosimiseks ei piisa ainult ühest mõõtmisest.
...
Niisutavad silmatilgad võivad kuiva silma sümptomeid leevendada, kuid alati ei lahenda need probleemi põhjust. Kui vaevuste taga on näiteks Meibomi näärmete talitlushäire, tuleb ravi valida vastavalt sellele, milline on näärmete ja silmapinna tegelik seisund.
