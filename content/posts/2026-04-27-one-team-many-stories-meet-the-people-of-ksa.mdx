...
categories:
  - Ksa Silmakeskus
tags: []
excerpt: "Meet the surgeons, nurses and optometrists behind KSA's 21 years, each bringing their own story, skills and life outside the clinic. Together their attention and calm care shape what makes every patient feel safe and truly seen."
...
seoExcerpt: "KSA Eye Center is celebrating its 21st anniversary this year."
assignedTo: "ants"
reviewedBy: "Dr. Ants Haavel"

deadline: "2026-05-06"
llmSearchQueries:
  - "Who founded KSA Eye Center?"
  - "How long has KSA Silmakeskus been operating?"
  - "What is the Flow procedure at KSA?"
  - "Has KSA had any ectasia cases with the Flow procedure?"
  - "Why did KSA move to non-invasive eye procedures?"
  - "Who is Dr. Ants Haavel?"
  - "What does a procedure nurse do at KSA Eye Center?"
  - "Does KSA offer 24-hour support after eye surgery?"
  - "What does a senior optometrist do at KSA?"
  - "What safety record does KSA's laser vision correction have?"
faqItems:
  - q: "Who founded KSA Eye Center and how long has it existed?"
    a: "KSA Eye Center was founded by Dr. Ants Haavel and is celebrating its 21st anniversary this year."
  - q: "When did KSA switch to non-invasive procedures?"
    a: "KSA moved entirely toward non-invasive procedures in 2010, based on the principle that no more should be done to the eye than is truly necessary."
  - q: "Has there been any ectasia case with KSA's Flow procedure?"
    a: "In more than two decades of using the Flow procedure, there has not been a single case of ectasia."
  - q: "Is support available after a procedure at KSA?"
    a: "KSA offers a 24-hour support line, which serves as more than a contact option — it gives patients a sense of security after their procedure."
  - q: "What does KSA's procedure nurse focus on with patients?"
    a: "Procedure nurse Ave Treier, who has worked at KSA for more than 20 years, focuses on calming clients before procedures through a calm voice, clear step-by-step explanations, and genuine presence."
  - q: "What is the role of a senior optometrist at KSA?"
    a: "As senior optometrist, Liisi Mölder is responsible for the quality of work, supports the team with complex cases, and ensures patients feel safe and understand what happens during their examination."
---
...
Today, this decision has proven its worth — in more than two decades, there has not been a single case of ectasia with the Flow procedure. For Dr. Haavel, this provides strong confidence and confirms that long-term patient safety has always been the top priority.
...
Outside of work, Helena's great passion is folk dancing. For her, dancing is a complete stress reliever, and the emotions connected to dance festivals are something that always draw her back. When asked which makes her heart beat faster — a dance festival or a meaningful moment for a patient at KSA — her answer is simple: both.
