...
An eye drop containing **atropine** at a very low concentration. In large doses, atropine strongly dilates the pupils — that's what we use at the eye exam. In small doses (0.05%, 0.025% or 0.01%), it slows down excessive eyeball growth without disrupting daily life.

The Hong Kong LAMP study tested all three strengths in children over several years. The result: **0.05% atropine was twice as effective as the 0.01% solution** at slowing myopia progression. One drop per eye before bed, every day.
