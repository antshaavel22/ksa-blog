...
faqItems:
  - q: "Why are eyes considered part of the brain?"
    a: "The eyes are an extension of the brain, so the raw materials that build brain function during pregnancy, breastfeeding, and early childhood also shape visual and neurological development."
  - q: "Do breastfed children score higher on IQ tests?"
    a: "Research consistently shows children fed exclusively on breast milk during their first year score higher on IQ tests than those raised on formula alone."
  - q: "What nutrients in breast milk support brain development?"
    a: "Omega-3 fatty acids and DHA were initially identified as key compounds, but dozens of other nutrients also matter—breast milk becomes richer and more diverse when a mother eats plenty of leafy greens and fresh vegetables during pregnancy and lactation."
  - q: "Can a nutrient deficiency affect a child's intelligence?"
    a: "Yes, a deficiency in any single one of more than forty essential nutrients during early childhood can produce lasting effects on memory and intelligence."
  - q: "Does brain development stop after infancy?"
    a: "No, brain growth continues through the teenage years and beyond, with full neurological maturity taking decades, so proper nutrition remains important well past infancy."
  - q: "Can early nutrition affect hyperactivity or attention disorders?"
    a: "Hyperactivity, attention disorders, depression, and other psychiatric conditions often originate in the nutrition patterns established during early childhood."
---
