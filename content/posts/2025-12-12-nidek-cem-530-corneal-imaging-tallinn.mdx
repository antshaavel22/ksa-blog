...
faqItems:
  - q: "What does the Nidek CEM-530 specular microscope do?"
    a: "It images the corneal endothelium at the cellular level, a single layer of cells about 5 micrometres thick that standard microscopes cannot see clearly. This allows KSA Silmakeskus to detect endothelial cell damage before symptoms appear."
  - q: "Why is the corneal endothelium important for vision?"
    a: "The endothelium acts as a pump that lets nutrients, oxygen and water flow into the cornea, keeping it hydrated and clear. When endothelial function fails, the cornea becomes cloudy and patients experience blurred vision, halos, discomfort, dryness and fatigue."
  - q: "Can contact lenses damage the endothelium?"
    a: "Elevated eye pressure, age, diabetes, cataract surgery, and years of wearing poor-quality contact lenses can all damage endothelial cells, which are hexagon-shaped and diminish over time, often silently. Dr. Ants Haavel notes that endothelial decline is often the reason contact lens wearers suddenly can't tolerate lenses anymore, even after years of trouble-free wear."
  - q: "How often should contact lens wearers get checked?"
    a: "Dr. Ants Haavel recommends contact lens wearers have a simple specular microscopy check once or twice a year during their routine eye exam."
  - q: "Does endothelial cell count matter before cataract surgery?"
    a: "Yes — you're born with your maximum endothelial cell count, and it only decreases from there, so a significantly reduced count calls for extra caution before any eye surgery. This is especially relevant for cataract surgery, which typically affects patients aged 60 and above, and the Nidek CEM-530 allows this risk to be assessed before surgery."
  - q: "Is the Nidek CEM-530 available elsewhere in Estonia?"
    a: "According to Dr. Ants Haavel, KSA Silmakeskus is currently the only clinic in Estonia with this equipment."
---
...
[Book a consultation](https://kiirtest.ksa.ee/en) to see what your cornea really looks like.
