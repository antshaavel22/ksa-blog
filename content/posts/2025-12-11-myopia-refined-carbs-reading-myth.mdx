...
excerpt: "Myopia has surged since the 1800s; reading can't explain it, since hunter-gatherers develop it within a generation of city life. The timing matches refined carbs and sugar, pointing to diet, not books."
...
faqItems:
  - q: "Does reading too much cause myopia?"
    a: "No. Countries with mandatory education have kept myopia rates low, while short-sightedness has spread in communities without formal schooling or reading traditions. The timing of the myopia surge lines up with the shift to industrialised, refined-carb diets rather than with increased reading."
  - q: "Is myopia genetic or inherited?"
    a: "Myopia does not appear to be inherited. When hunter-gatherer populations moved to cities, myopia rates rose sharply within a single generation—far too fast to result from genetic mutation, which rules out simple inheritance."
  - q: "Why is myopia rare in wild animals?"
    a: "Every mammal and bird is either far-sighted or has normal vision, seeing clearly beyond six metres, because sharp distance vision is essential for spotting predators, finding food, and recognizing kin. A gene causing myopia would be an evolutionary liability and would be eliminated by natural selection."
  - q: "What actually causes myopia rates to rise?"
    a: "Myopia surged not when reading became widespread, but when industrialised diets replaced whole foods with refined carbohydrates, processed sugars, and nutrient-depleted staples. This dietary shift correlates with the eyeball elongating and distance vision blurring."
  - q: "How common is myopia today compared to the past?"
    a: "In the US, myopia affects roughly 25–35% of people of European descent, and in East Asia the figure climbs to nearly 50%. In societies without formal schooling and with traditional diets, myopia affected only about 2% of the population."
  - q: "Can myopia be corrected if diet changes come too late?"
    a: "For those already dealing with myopia, procedures such as Flow3 laser eye surgery or ICB lens replacement can correct it permanently. For parents, protecting a child's diet from an early stage is presented as the first line of prevention."
---
