...
date: "2026-07-15"
author: "Silvia Johanna Haavel"
categories:
  - Edulood
  - Flow Protseduur
  - Ksa Silmakeskus
tags: []
excerpt: "For Jane, glasses and contact lenses never kept up with dance, surfing or snowboarding. A suitability test, a same-day answer and one quick procedure later, mornings simply start with seeing clearly."
featuredImage: "/uploads/2026/07/d5cb90fd-918f-4ffa-80e8-06d0794090ba-mrkk63wv.webp"
lang: "en"
ctaType: "kiirtest-soft"
medicalReview: false
seoTitle: "You Wake Up in the Morning and See Right Away: Jane's Journey to a Life Without Glasses"
seoExcerpt: "Jane is 23, a physiotherapist and a dance teacher."
assignedTo: "ants"
deadline: "2026-07-14"
reviewedBy: "Dr. Ants Haavel"
llmSearchQueries:
  - "How does laser eye surgery help active people like dancers and surfers?"
  - "What is it like to get laser vision correction at KSA Silmakeskus?"
  - "Can glasses be a problem for sports like snowboarding and dance?"
  - "What happens during a suitability exam for laser eye procedures?"
  - "How many eye tests are done before laser vision correction?"
  - "Is it normal to feel nervous before a laser eye procedure?"
  - "What questions do people usually ask before laser eye surgery?"
  - "How long does the vision correction procedure take at KSA Tallinn clinic?"
  - "Why do glasses fall off during dance or sports training?"
  - "What does the online suitability test on KSA's website show?"
faqItems:
  - q: "Why did Jane consider laser vision correction?"
    a: "As a physiotherapist and dance teacher active in surfing, snowboarding, and climbing, Jane found glasses to be a constant obstacle rather than a companion — they slipped, fell off during dance turns, and undermined her confidence at competitions."
  - q: "How did Jane find out if she was suitable for the procedure?"
    a: "She first took the quick online suitability test on KSA's website, which showed a high probability that a laser procedure would suit her eyes, before booking an in-person exam."
  - q: "What happens during the suitability exam at KSA?"
    a: "Jane described undergoing around thirty different eye tests, with the optometrist explaining each step and finding in plain language. The result came the same day, confirming her eyes were a good fit for the laser procedure."
  - q: "Is it normal to feel nervous before laser eye surgery?"
    a: "Yes — Jane was slightly nervous on the day of the procedure, which she describes as completely normal. The calm, welcoming atmosphere at the clinic and clear recovery instructions beforehand helped ease that nervousness."
  - q: "What common questions do people have before a laser procedure?"
    a: "Jane's questions were the same ones most people ask: how long the procedure takes, how the eyes are numbed, what sensations to expect, and what happens if you blink. The doctor answered these calmly and shared his own personal experience with the procedure."
---
