...
categories:
  ...
  - Tehnoloogia
tags: []
excerpt: "Uued prilliklaasid moonutavad ruumi ja kaugusi, mistõttu aju peab end ümber häälestama. Kohanemine võtab nädalaid ja nõuab lisaenergiat, mis tekitab väsimust ja survetunnet oimukohtades."
...
llmSearchQueries:
  - "miks uued prillid tekitavad peavalu"
  - "miks maailm tundub prillidega viltu"
  - "kuidas aju harjub uute prillidega"
  - "miks tekib prillidega iiveldus ja pearinglus"
  - "kui kaua kulub prillidega harjumiseks aega"
  - "mis on tünnmoonutus ja padimoonutus prilliklaasides"
  - "miks miinusklaasid teevad esemed väiksemaks"
  - "mis on vestibulo-okulaarne refleks ja prillid"
  - "kuidas vabaneda prillidest laseriga"
  - "miks silmad väsivad prille kandes tööpäeva lõpuks"
faqItems:
  - q: "Miks tunnen end uute prillidega esialgu tasakaalutuna?"
    a: "Uued prilliklaasid muudavad valguse füüsikalisi omadusi ja moonutavad kujutise geomeetriat, mistõttu aju peab hakkama seda infot ümber kirjutama. Kuni aju on kohanenud, tekib konflikt sisekõrva tasakaaluandurite ja silmade nähtava pildi vahel, mis põhjustab kõikuvat tunnet."
  - q: "Miks tekivad uute prillidega peavalu ja iiveldus?"
    a: "Prilliklaasid häirivad vestibulo-okulaarset refleksi (VOR), mis tavaliselt hoiab pilti silme ees stabiilsena pea liikumisel. Kui refleksi suhe ei vasta enam klaaside moonutustele, hakkab pilt libisema (retinal slip), mis põhjustab silmade väsimust, peavalu, uimasust ja halba enesetunnet."
  - q: "Kui kaua kestab uute prillidega harjumine?"
    a: "Sümptomid kaovad tavaliselt umbes nädalaga, kuna aju hakkab tänu neuroplastilisusele VOR-stabilisaatorit ümber seadistama ja moonutusi teadvusest välja filtreerima."
  - q: "Mille poolest erinevad miinus- ja plussklaaside moonutused?"
    a: "Miinusklaasid (lühinägevuse jaoks) teevad pildi väiksemaks ja tekitavad äärtes tünnmoonutust, kus sirged jooned kaarduvad väljapoole. Plussklaasid (kaugnägevuse jaoks) suurendavad pilti ja tekitavad padimoonutust, kus sirged jooned painduvad sissepoole."
  - q: "Miks tunnen prille kandes tööpäeva lõpuks rohkem väsimust?"
    a: "Aju kulutab pidevalt lisaenergiat prilliklaaside tekitatud moonutuste korrigeerimiseks ja pildi \"toimetamiseks\". See pidev taustatöö on peamine põhjus, miks paljud prillikandjad tunnevad päeva lõpuks väsimust ja survetunnet oimukohtades või silmade taga."
  - q: "Kas prilliklaaside moonutused kaovad harjumisega?"
    a: "Moonutused ise ei kao klaasidest kunagi, kuid aju õpib need aja jooksul teadvusest välja filtreerima, muutes need kasutaja jaoks nähtamatuks – sarnaselt sellele, kuidas inimene harjub rongimüraga ega pane seda enam tähele."
---
