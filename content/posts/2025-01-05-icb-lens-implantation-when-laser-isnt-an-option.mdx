...
faqItems:
  - q: "What is an ICB lens and how does it work?"
    a: "ICB stands for Intraocular Collamer Lens, a tiny, ultra-thin lens made from a biocompatible material called collamer. It's placed inside the eye between the iris and the natural lens, without removing or replacing anything of the eye's own anatomy."
  - q: "Who is a good candidate for ICB instead of laser surgery?"
    a: "ICB tends to suit people with high prescriptions (typically –6 and above, sometimes –10 to –20 or more), thin corneas that can't safely undergo reshaping, or severe dry eyes. It's also an option for those who want reversibility, since the lens can be removed or exchanged later, unlike laser reshaping."
  - q: "Is ICB implantation surgery painful?"
    a: "The procedure is performed while awake but with anaesthetic drops that numb the eye completely, so patients don't feel pain. Most describe it as strange but painless, with some pressure and odd light sensations during the 10–15 minutes per eye it takes."
  - q: "How long does recovery take after ICB lens implantation?"
    a: "Most patients notice dramatically improved vision within 24–48 hours and many return to work the next day. Full stabilisation takes 2–4 weeks, with prescribed eye drops and a couple of follow-up appointments during that time."
  - q: "How is ICB different from cataract surgery?"
    a: "In cataract surgery, the eye's natural lens is removed and replaced with an artificial one. With ICB lens implantation, the natural lens stays exactly where it is, and the collamer lens is simply added between the iris and the natural lens."
  - q: "Why would someone not qualify for laser eye surgery?"
    a: "Laser vision correction reaches its limits with prescriptions beyond roughly –10, and it requires enough corneal thickness to safely reshape the tissue. Severe dry eyes can also make laser recovery difficult, which is why ICB may be recommended instead."
---
...
Not a sales pitch. Just an honest look at what's possible for your eyes. [Take the free quick test](https://kiirtest.ksa.ee/en) to see if you might be a candidate — it takes two minutes, and there's zero obligation.
