---
title: "Slowing the Growth: The Science Stopping Childhood Myopia in Its Tracks"
slug: "slowing-the-growth-the-revolutionary-science-stopping"
date: "2026-08-24"
...
categories:
  ...
  - Tehnoloogia
tags: []
excerpt: "Standard glasses focus peripheral light behind the retina, signalling the eye to keep growing. A US trial found multifocal lenses cut elongation by a third and progression by 43%."
featuredImage: "/uploads/2026/08/blink-study-ksa-vision-clinic-mssr15ne.webp"
lang: "en"
ctaType: "kiirtest-soft"
medicalReview: false
seoTitle: "Slowing the Growth: The Science Stopping Childhood Myopia in Its Tracks"
seoExcerpt: 'Have you ever looked at a pair of glasses and thought of them as a "cure"?  For generations, we have treated glasses like a simple, passive fix.'
assignedTo: "ants"
deadline: "2026-08-14"
reviewedBy: "Dr. Ants Haavel"
llmSearchQueries:
  - "how to slow childhood myopia progression"
  - "can glasses make myopia worse in children"
  - "what is peripheral hyperopic defocus"
  - "soft multifocal contact lenses for myopia control"
  - "what did the BLINK study prove about myopia"
  - "why does myopia keep getting worse in kids"
  - "how does high myopia increase risk of retinal detachment"
  - "what percentage of the world will be nearsighted by 2050"
  - "do standard glasses cause the eye to keep growing"
  - "how do multifocal lenses stop eye elongation"
faqItems:
  - q: "Can standard glasses make a child's myopia worse?"
    a: "Standard single-vision glasses correct the center of vision but focus peripheral light behind the retina, a condition called peripheral hyperopic defocus. This sends a signal to the eye that it needs to keep growing longer, which can accelerate myopia progression."
  - q: "What is peripheral hyperopic defocus?"
    a: "It's when light entering the sides of the eye focuses behind the retina instead of on it, due to the eye's curved shape combined with standard lens correction. The retina interprets this as a sign the eyeball is too short, triggering continued elongation."
  - q: "How do soft multifocal contact lenses slow myopia?"
    a: "These lenses have a center zone that corrects distance vision and outer rings that bend peripheral light to focus in front of the retina rather than behind it. This front-focused signal acts as a stop sign for eye growth, slowing physical elongation of the eyeball."
  - q: "What did the BLINK study find about myopia control?"
    a: "The BLINK Study was a three-year clinical trial funded by the National Eye Institute investigating Bifocal Lenses In Nearsighted Kids, testing whether soft multifocal contact lenses could slow myopia progression in children."
  - q: "Why is high myopia dangerous beyond needing stronger glasses?"
    a: "High myopia, defined as -5.00 diopters or worse, physically stretches and thins eye tissue as the eyeball elongates. This stretching raises the risk of serious complications later in life, including cataracts, glaucoma, and retinal detachment."
  - q: "How common will myopia be worldwide by 2050?"
    a: "Projections suggest nearly half of the global population, about 54%, will be nearsighted by 2050. In some developed regions of East and Southeast Asia, myopia rates among teenagers finishing high school already reach 80% to 90%."
---
Have you ever looked at a pair of glasses and thought of them as a "cure"?

For generations, we have treated glasses like a simple, passive fix. Your vision gets blurry, you put on a pair of lenses, and suddenly the world is in high definition again. But behind the scenes, there is a quiet, global emergency unfolding inside our children's eyes, and standard glasses might actually be making it worse.
...
But here is the good news: we are no longer helpless. Clinical trials funded by the National Eye Institute (NEI) have revealed that we can actually send a physical "stop sign" to a child's growing eye, halting myopia in its tracks.
...
## The Bullseye Approach: Soft Multifocal Lenses

To trick the eye into stopping this growth, scientists turned to the defocus theory and developed a clever piece of engineering: soft multifocal contact lenses.
...
The results, published in the Journal of the American Medical Association, were striking:
...
While advanced lens technology plays an important role, there is another highly effective, completely free preventative tool: the great outdoors.
...
**The Dopamine Signal:** Natural sunlight is far brighter than indoor lighting. Exposure to this intense light triggers a massive release of dopamine in the retina. This dopamine acts as a natural biochemical brake, tightly regulating eye development and stopping the eyeball from stretching.
...
By combining healthy lifestyle habits—like daily outdoor play—with modern optometric treatments when needed, we can successfully win the battle against childhood myopia and protect our children's visual freedom for life.