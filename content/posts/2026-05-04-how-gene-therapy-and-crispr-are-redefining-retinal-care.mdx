...
categories:
  ...
  - Ksa Silmakeskus
tags: []
excerpt: "Since Luxturna's 2017 approval, gene therapy has advanced to CRISPR-based editing that repairs faulty DNA in the eye. Risks like immune reactions and off-target edits remain, alongside questions of affordability."
featuredImage: "/uploads/2026/05/crisp-technology-ksa-vision-clinic-mor4z52u.webp"
lang: "en"
ctaType: "kiirtest-soft"
medicalReview: false
seoTitle: "How Gene Therapy and CRISPR are Redefining Retinal Care"
seoExcerpt: "Welcome back to the KSA Vision Clinic blog and the final installment of our three-part series on the future of regenerative eye care."
assignedTo: "ants"
deadline: "2026-05-04"
reviewedBy: "Dr. Ants Haavel"
llmSearchQueries:
  - "How does gene therapy treat inherited retinal diseases?"
  - "What is CRISPR genome surgery for the eye?"
  - "Is Luxturna gene therapy approved for retinal disease?"
  - "Can CRISPR cure Retinitis Pigmentosa or Stargardt disease?"
  - "What are the risks of gene therapy for vision loss?"
  - "Why can't large genes like ABCA4 fit into AAV vectors?"
  - "What is the difference between gene augmentation and CRISPR editing?"
  - "How does in vivo CRISPR treatment work in the eye?"
  - "What ethical concerns exist around gene therapy access?"
  - "Can gene therapy slow vision loss regardless of genetic mutation?"
faqItems:
  - q: "What was the first approved gene therapy for eye disease?"
    a: "Luxturna, approved by the FDA in 2017, was the first gene therapy approved for humans and treats Leber Congenital Amaurosis caused by a specific RPE65 mutation using a viral vector to deliver a healthy gene copy into the retina."
  - q: "Why can't all retinal genes be delivered with standard gene therapy?"
    a: "Viral vectors like AAV have a strict cargo limit, so large genes such as ABCA4, responsible for Stargardt disease, are too big to fit inside standard vectors, requiring workarounds like dual-vector therapies or RNA exon editing."
  - q: "How is CRISPR different from traditional gene therapy?"
    a: "Traditional gene therapy adds a missing functional gene, while CRISPR acts as molecular scissors that can precisely excise a defective mutant allele and replace it with a functional one, described as 'genome surgery.'"
  - q: "What does in vivo CRISPR treatment mean for the eye?"
    a: "In vivo CRISPR therapy delivers gene-editing tools directly into the living eye, rather than editing cells in a lab and re-implanting them, which makes the procedure less invasive and allows for quicker, more tolerable recovery."
  - q: "What are the main risks of CRISPR and gene therapy?"
    a: "Risks include the immune system reacting to viral vectors, causing ocular inflammation or dose-dependent toxicity, and off-target effects where new genetic material integrates into the wrong part of the DNA, potentially disrupting healthy genes."
  - q: "Will gene therapy for eye disease be accessible to everyone?"
    a: "Custom genetic vectors are very expensive to develop and manufacture, raising equitable access concerns that the medical community must address through new healthcare and insurance models."
---
...
At KSA Vision Clinic, our role is to help you navigate these breakthroughs with a clear, realistic perspective. Gene therapy is a highly complex frontier, and it carries profound clinical and bioethical risks.
...
Finally, there is the ethical dilemma of equitable access. The development and manufacturing of custom genetic vectors are very expensive. The medical community must work diligently to create new healthcare and insurance models so that these therapies do not become exclusively available to the wealthy.
