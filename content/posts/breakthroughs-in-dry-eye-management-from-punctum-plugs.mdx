...
slug: "breakthroughs-in-dry-eye-management-from-punctum-plugs"
date: '2026-03-20'
author: Dr. Ants Haavel
categories:
  - Elustiil
tags: []
excerpt: "When drops fail, chronic dry eye may need punctum plugs or QMR therapy (4–64 MHz) to ease inflammation. Four 20-minute weekly sessions help most, best paired with other treatments."
...
seoExcerpt: >-
  ...
  fall short. Dr.
llmSearchQueries:
  - "What is Rexon-Eye treatment for dry eyes?"
  - "How does QMR Quantum Molecular Resonance work for dry eye?"
  - "Are punctum plugs effective for chronic dry eye syndrome?"
  - "What to do when artificial tears don't help dry eye?"
  - "How many Rexon-Eye sessions are needed for dry eye relief?"
  - "Is Rexon-Eye a first-line treatment for dry eye syndrome?"
  - "What are advanced treatments for evaporative dry eye?"
  - "Does Rexon-Eye improve Schirmer's test or TBUT results?"
  - "How does Rexon-Eye reduce eye inflammation?"
  - "What happens during a Rexon-Eye therapy session?"
faqItems:
  - q: "What is Rexon-Eye and how does it treat dry eye?"
    a: "Rexon-Eye is a non-invasive treatment system that uses QMR (Quantum Molecular Resonance) technology to support ocular surface tissue function and improve tear film quality. It targets the underlying causes of dry eye rather than only masking symptoms, and is used for evaporative, aqueous-deficient, and mixed types of dry eye."
  - q: "How does QMR technology work on the eyes?"
    a: "QMR delivers a weak alternating electrical current using a patented mix of high-frequency fields between 4 MHz and 64 MHz, which stimulates cellular metabolism and tissue regeneration. It also modulates macrophage polarization, shifting cells from a pro-inflammatory to an anti-inflammatory state, helping reduce inflammation and stabilize the tear film."
  - q: "How many Rexon-Eye sessions are typically needed?"
    a: "The standard protocol involves four treatment sessions, each lasting 20 minutes, spaced one week apart. The procedure requires no recovery time afterward."
  - q: "What are punctum plugs used for in dry eye treatment?"
    a: "Punctum plugs are tiny, biocompatible inserts placed in the tear ducts to temporarily block drainage, allowing natural tears and lubricating drops to stay on the eye's surface longer. This provides sustained moisture and relief, particularly for aqueous-deficient dry eye."
  - q: "Is Rexon-Eye a guaranteed cure for dry eye syndrome?"
    a: "No. Dr. Karl-Erik Tillmann emphasizes a realistic, clinical perspective, noting that while subjective symptoms often improve, clinical studies have not uniformly shown improvement in objective measures like Schirmer's test or Tear Break-Up Time. Rexon-Eye is not considered a first-line treatment for every case, especially severe aqueous deficiency with active inflammation."
  - q: "What happens during a Rexon-Eye treatment session?"
    a: "The therapy is delivered through contact electrodes built into a mask worn over closed eyes, with disposable tissues placed between the mask and face for hygiene and even stimulation spread. Sessions include relaxing audio guides with nature or spa sounds to support patient comfort."
---
