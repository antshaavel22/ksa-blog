...
slug: "what-medication-do-you-give-them-german-surgeons-went"
date: "2026-06-26"
...
categories:
  ...
  - Ksa Silmakeskus
tags: []
excerpt: "German surgeons kept asking what drug calms KSA's laser patients. It's actually nurse Ave Treier, 21 years in, whose calm voice and breathing routine ease fear before surgery starts."
...
seoExcerpt: "Visiting surgeons from Germany asked us again and again what medication we use to keep patients so calm under the laser."
assignedTo: "ants"
deadline: "2026-06-17"
reviewedBy: "Dr. Ants Haavel"
llmSearchQueries:
  - "why are patients so calm during laser eye surgery at KSA"
  - "what medication is used to calm patients before eye surgery"
  - "who is Ave Treier at KSA Silmakeskus"
  - "how does KSA prepare patients before Flow laser surgery"
  - "is there a sedative used before LASIK or Flow surgery"
  - "how to stay calm before eye surgery without medication"
  - "what happens in the minutes before laser eye surgery"
  - "how long has KSA Silmakeskus been operating in Tallinn"
  - "why did German surgeons ask about KSA's secret drug"
  - "what makes KSA Silmakeskus different from other eye clinics"
faqItems:
  - q: "What medication does KSA give patients before laser surgery?"
    a: "There is no medication involved. The calm patients show under the laser comes from procedure nurse Ave Treier, who speaks with each patient in a calm, low voice and matches their breathing before they meet the surgeon."
  - q: "Who is Ave Treier at KSA Silmakeskus?"
    a: "Ave Treier is a procedure nurse who has worked at KSA for more than 21 years, since before the clinic had its own building. She meets every Flow patient before the surgeon does."
  - q: "Why did German surgeons ask about KSA's 'secret drug'?"
    a: "Visiting surgeons from Germany repeatedly asked what medication KSA uses to keep patients calm under the laser, because the calmness they observed seemed remarkable. The answer given was simply Ave, the procedure nurse who talks with patients beforehand."
  - q: "How does KSA help patients manage fear before eye surgery?"
    a: "According to Ave Treier, fear comes from not knowing, so she explains exactly what a patient might feel and what to expect, speaking slowly and steadily to slow the whole moment down before surgery."
  - q: "How long has KSA Silmakeskus existed?"
    a: "KSA Silmakeskus was founded by Dr Ants Haavel, with Ave Treier joining the team in 2005 before the clinic even had its own premises, making her tenure over 21 years."
  - q: "What has changed most at KSA over the past 21 years?"
    a: "Ave Treier notes that technology and scale have changed the most, moving from early laser surgery that felt like science fiction to today's Flow method with ultra-fast lasers, while the clinic's focus on patient wellbeing and teamwork has stayed the same."
---
...
**Ave Treier:** The biggest change is, without a doubt, the technology and the scale. We began at a time when laser surgery still felt like science fiction to most people. Today we have the Flow method, ultra-fast lasers and an entirely different tempo.
...
I bring in a doctor or optometrist immediately when it's a mechanical trauma — for example if the protective lens has come out of the eye, the eye is red and painful. We have strong teamwork: if needed, an optometrist or doctor will come to the clinic outside working hours to check a patient's eye.
