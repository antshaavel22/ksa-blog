...
categories:
  ...
  - Silmad Ja Tervis
tags: []
excerpt: "Igal viiendal eelkooliealisel lapsel esineb nägemishäireid, kuid koolis tehtav nägemistabeli test ei paljasta fookustamis- ega koostööprobleeme. Lapsed kompenseerivad puudujääke sageli aastaid märkamatult, seetõttu soovitatakse põhjalikku silmakontrolli juba vanuses 6–12 kuud."
