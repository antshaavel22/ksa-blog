...
slug: "nahtamatust-nagemisest-nutika-tervisejalgimiseni"
date: "2026-05-16"
...
categories:
  ...
  - Ksa Silmakeskus
tags: []
excerpt: "Üleskonverteerivad nanoosakesed muudavad infrapunavalguse nähtavaks, andes kontaktläätsedele öönägemisvõime ja venivatele kiududele täpse kehatemperatuuri mõõtmise. Läätsed toimivad paremini suletud silmadega, kiud püsivad täpsed ka 80% venitatuna."
...
seoExcerpt: "Kujuta ette maailma, kus sinu trenniriided suudavad sulle öelda, et hakkad haigeks jääma, juba enne kui tunned palavikku, või kus lihtsad pehmed kontaktläätsed annavad sulle võime näha täiesti nähtamatut valgust."
assignedTo: "ants"
deadline: "2026-05-04"
reviewedBy: "Dr. Ants Haavel"
llmSearchQueries:
  - "mis on üleskonverteerivad nanoosakesed"
  - "kuidas kontaktläätsed võimaldavad näha infrapunavalgust"
  - "kas inimene saab näha infrapunavalgust kontaktläätsedega"
  - "mis on anti-Stokes'i kiirgus lihtsalt seletatuna"
  - "millised nanoosakesed on kasutusel infrapuna kontaktläätsedes"
  - "kuidas nutikad kontaktläätsed tervist jälgivad"
  - "kas nähtamatu valguse nägemine on ohutu silmadele"
  - "milleks kasutatakse erbiumi ja üterbiumi meditsiinitehnoloogias"
  - "kuidas Hiina teadlased lõid infrapuna kontaktläätsed"
  - "mis on kantava tehnoloogia tulevik silmade jaoks"
faqItems:
  - q: "Mis on üleskonverteerivad nanoosakesed?"
    a: "Üleskonverteerivad nanoosakesed (UCNP) on umbes 45 nanomeetri suurused osakesed, mis suudavad neelata kaks või enam madala energiaga infrapuna footonit ja kiirata välja ühe kõrgema energiaga footoni, mida inimsilm juba näeb. See nähtus kannab nime anti-Stokes'i kiirgus."
  - q: "Kuidas kontaktläätsed infrapunavalgust nähtavaks muudavad?"
    a: "Hiina Teadus- ja Tehnoloogiaülikooli teadlased ühendasid tavapärased painduvad läätsepolümeerid üleskonverteerivate nanoosakestega, mis sisaldavad kulda ning haruldasi muldmetalle erbium ja üterbium. Need osakesed muudavad nähtamatu lähi-infrapunavalguse footonid inimsilmale nähtavaks valguseks."
  - q: "Kas nanoosakestega kontaktläätsed jäävad tavaliseks nägemiseks läbipaistvaks?"
    a: "Jah, nanoosakeste pinda hoolikalt reguleerides saavutati 7–9% integratsioon, samas kui läätsed jäid tavalise nähtava valguse jaoks enam kui 90% ulatuses läbipaistvaks. Testid näitasid, et läätsed ei ole mürgised ja sobivad silmadega hästi."
  - q: "Kas neid infrapuna-kontaktläätsi on juba katsetatud?"
    a: "Läätsi katsetati nii hiirtel kui inimestel. Hiired vältisid aktiivselt nähtamatu infrapunavalgusega valgustatud kaste, mis näitas, et nad hakkasid seda tajuma, samas inimesed suutsid läätsi kandes ära tunda mustreid ja lahti kodeerida infrapunalaseriga edastatud morsekoodi signaale."
  - q: "Miks inimsilm tavaliselt infrapunavalgust ei näe?"
    a: "Inimeste ja teiste püsisoojaste loomade silmades puuduvad infrapunavalguse tajumiseks vajalikud bioloogilised retseptorid ning keha enda soojus segaks selle valguse tajumist. Ainult mõned kõigusoojased loomad, näiteks maod ja tiikkonnad, on arendanud võime seda valgust tunnetada."
  - q: "Milleks kasutatakse üleskonverteerivaid nanoosakesi lisaks nägemisele?"
    a: "Need osakesed mängivad rolli ka painduvates optilistes kiududes, mis on loodud reaalajas kehatemperatuuri jälgimiseks, mis on osa laiemast kantava tervisejälgimise tehnoloogia arengust."
---
