...
excerpt: "Rubbing itchy spring eyes releases more histamine, worsening the cycle. Cold compresses, saline rinses and spotting your trigger help; see a specialist for pain or vision changes."
...
faqItems:
  - q: "Why do my eyes itch so much in spring?"
    a: "Spring itching is caused by histamine and other inflammatory compounds released by mast cells in the eye when they encounter airborne pollen from trees, plants, and grasses. It's not the pollen itself but this histamine reaction that triggers the itch, redness, and watering."
  - q: "Why does rubbing my eyes make allergies worse?"
    a: "Rubbing releases more histamine, the chemical your body produces when it encounters an allergen, which intensifies the itch and creates a cycle of itch, rub, and worse itch. It's better to use a cold compress instead of rubbing."
  - q: "How can I tell if my eye allergies are from pollen or something else?"
    a: "If eyes only flare up during spring, pollen is almost certainly the cause. If symptoms persist all year, the trigger is more likely pet dander, dust mites, mold spores, or contact lens material or solution."
  - q: "What home remedies help with itchy allergy eyes?"
    a: "Removing makeup and contact lenses, washing hands frequently, applying a cold compress with a cloth soaked in cool boiled water, and using saline or antihistamine eye drops can ease discomfort. Plain lukewarm boiled water can also work as a gentle rinse."
  - q: "How can I prevent spring eye allergies from pollen?"
    a: "Spend more time indoors during high pollen days, keep windows closed, and wear sunglasses for added protection against airborne pollen."
  - q: "When should I see an eye doctor for allergy symptoms?"
    a: "See an eye specialist if symptoms persist despite self-care, or if your eyes become painful or your vision changes, since allergies can sometimes mask other eye conditions. A GP can also arrange allergy tests to pinpoint your specific triggers."
---
