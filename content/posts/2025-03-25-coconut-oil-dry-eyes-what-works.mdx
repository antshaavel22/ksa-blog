...
faqItems:
  - q: "Does coconut oil help with dry eyes?"
    a: "Coconut oil contains fatty acids that can theoretically support the oily outer layer of the tear film, but it is too thick for the eye, can blur vision, and does not address the root cause of dryness. If used at all, it should be applied sparingly to eyelid skin only, never directly in the eye."
  - q: "What actually causes dry eyes?"
    a: "Dry eyes develop when tear production slows, tears evaporate too quickly, or environmental factors are unfavorable. Common triggers include medications like antihistamines and antidepressants, systemic conditions such as diabetes and rheumatoid arthritis, hormonal changes, nutritional deficiencies, and heavy screen time."
  - q: "Can screen time cause dry eyes?"
    a: "Yes. Computer monitors, tablets, phones, and TVs reduce blink rate dramatically, and less blinking means less tear distribution across the eye's surface."
  - q: "Do over-the-counter eye drops fix dry eyes?"
    a: "Artificial tears manage symptoms rather than fix the underlying problem, and some formulations contain preservatives that can irritate eyes further with repeated use. Preservative-free drops, especially hyaluronic acid formulations, are gentler options for temporary relief."
  - q: "Can LASIK surgery cause dry eyes?"
    a: "Yes, LASIK and other laser eye procedures can sometimes trigger temporary dry eyes during recovery. Flapless technologies like Flow3 are chosen because they minimise corneal nerve disruption and reduce dryness risk."
  - q: "What helps dry eyes besides eye drops?"
    a: "Addressing the root cause matters most: reviewing medications with a doctor, supplementing omega-3 and vitamin A after checking dosage, and following the 20-20-20 rule for screen use. Warm compresses to unblock eyelid oil glands, humidifying the environment, and blinking deliberately also support healthier tear film."
---
